...
#define LOCTEXT_NAMESPACE "VisibilityPropertyTrackEditor"
...
FText FVisibilityPropertyTrackEditor::GetDisplayName() const
{
	return LOCTEXT("VisibilityPropertyTrackEditor_DisplayName", "Visibility Property");
}
