...
#define LOCTEXT_NAMESPACE "BytePropertyTrackEditor"
...
FText FBytePropertyTrackEditor::GetDisplayName() const
{
	return LOCTEXT("BytePropertyTrackEditor_DisplayName", "Byte Property");
}
